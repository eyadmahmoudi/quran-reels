  ...
  return (
    <div
      className={cn(
        ...
        'border-zinc-200 bg-background/85 dark:border-zinc-800 dark:bg-background/80',
      )}
      style={{ paddingBottom: 'calc(0.75rem + env(safe-area-inset-bottom))' }}
    >
      {isGenerating ? (
        <div className="flex items-center gap-2">
          <div className="relative h-11 flex-1 overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
            <div
          ...
          <button
            ...
            aria-label="Cancel"
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-500 transition-colors hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
