...
export const POPULAR_RECITERS: ReciterOption[] = [
  ...
  { id: 3,  name: 'Abdullah Al-Matroud',                   arabicName: 'عبدالله المطرود',           folder: 'Abdullah_Matroud_128kbps',       qdcRecitationId: null },
  { id: 4,  name: 'Abdurrahman As-Sudais',                 arabicName: 'عبدالرحمن السديس',          folder: 'Abdurrahmaan_As-Sudais_192kbps', qdcRecitationId: 3 },
  { id: 5,  name: 'Abu Bakr Ash-Shaatree',                 arabicName: 'أبو بكر الشاطري',           folder: 'Abu_Bakr_Ash-Shaatree_128kbps',  qdcRecitationId: 4 },
  { id: 6,  name: 'Al-Husary (Mujawwad)',                  arabicName: 'الحصري مجوّد',              folder: 'Husary_Mujawwad_64kbps',         qdcRecitationId: null },
  { id: 7,  name: 'Hani Ar-Rifai',                         arabicName: 'هاني الرفاعي',              folder: 'Hani_Rifai_64kbps',              qdcRecitationId: 5 },
  { id: 8,  name: 'Maher Al-Muaiqly',                      arabicName: 'ماهر المعيقلي',             folder: 'Maher_AlMuaiqly_64kbps',         qdcRecitationId: null },
  { id: 9,  name: 'Mahmoud Khalil Al-Husary',              arabicName: 'محمود خليل الحصري',         folder: 'Husary_128kbps',                 qdcRecitationId: 6 },
  { id: 10, name: 'Mahmoud Khalil Al-Husary (Muallim)',    arabicName: 'محمود خليل الحصري (معلم)',  folder: 'Husary_Muallim_128kbps',         qdcRecitationId: 12 },
  { id: 11, name: 'Mishari Rashid Al-Afasy',               arabicName: 'مشاري راشد العفاسي',        folder: 'Alafasy_128kbps',                qdcRecitationId: 7 },
  { id: 12, name: 'Mohamed Al-Tablawi',                    arabicName: 'محمد الطبلاوي',             folder: 'Mohammad_al_Tablaway_128kbps',   qdcRecitationId: 11 },
  { id: 13, name: 'Mohamed Siddiq Al-Minshawi (Mujawwad)', arabicName: 'محمد صديق المنشاوي مجوّد',  folder: 'Minshawy_Mujawwad_64kbps',       qdcRecitationId: 8 },
  { id: 14, name: 'Mohamed Siddiq Al-Minshawi (Murattal)', arabicName: 'محمد صديق المنشاوي مرتل',   folder: 'Minshawy_Murattal_128kbps',      qdcRecitationId: 9 },
  { id: 15, name: 'Muhammad Ayyoub',                       arabicName: 'محمد أيوب',                 folder: 'Muhammad_Ayyoub_128kbps',        qdcRecitationId: null },
  { id: 16, name: 'Nasser Al-Qatami',                      arabicName: 'ناصر القطامي',              folder: 'Nasser_Alqatami_128kbps',        qdcRecitationId: null },
  { id: 17, name: 'Saad Al-Ghamdi',                        arabicName: 'سعد الغامدي',               folder: 'Ghamadi_40kbps',                 qdcRecitationId: null },
  { id: 18, name: "Sa'ud Ash-Shuraym",                     arabicName: 'سعود الشريم',               folder: 'Saood_ash-Shuraym_128kbps',      qdcRecitationId: 10 },
  { id: 19, name: 'Yasser Al-Dosari',                      arabicName: 'ياسر الدوسري',              folder: 'Yasser_Ad-Dussary_128kbps',      qdcRecitationId: null },
]
