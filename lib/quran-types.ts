...
export const POPULAR_RECITERS: ReciterOption[] = [
  ...
  { id: 2,  name: 'Abdul Basit (Murattal)',       arabicName: 'عبد الباسط عبد الصمد', folder: 'Abdul_Basit_Murattal_128kbps' },
  ...
  { id: 7,  name: 'Al-Husary (Mujawwad)',         arabicName: 'الحصري مجوّد',         folder: 'Husary_Mujawwad_128kbps' },
  { id: 8,  name: 'Saad Al-Ghamdi',              arabicName: 'سعد الغامدي',          folder: 'Ghamadi_40kbps' },
  { id: 9,  name: 'Maher Al-Muaiqly',            arabicName: 'ماهر المعيقلي',        folder: 'Maher_AlMuaiqly_128kbps' },
  { id: 10, name: 'Hani Ar-Rifai',               arabicName: 'هاني الرفاعي',         folder: 'Hani_Rifai_64kbps' },
  { id: 11, name: 'Mohammad al-Tablawi',          arabicName: 'محمد الطبلاوي',        folder: 'Mohammad_al_Tablawi_128kbps' },
  { id: 12, name: 'Ahmed ibn Ali al-Ajamy',       arabicName: 'أحمد بن علي العجمي',   folder: 'Ahmed_ibn_Ali_al-Ajamy_128kbps_ketabook' },
  { id: 13, name: 'Ibrahim Al-Akhdar',            arabicName: 'إبراهيم الأخضر',       folder: 'Ibrahim_Akhdar_128kbps' },
  { id: 14, name: 'Yasser Al-Dosari',             arabicName: 'ياسر الدوسري',         folder: 'Yasser_Ad-Dussary_128kbps' },
]

export const TRANSLATION_RESOURCES = [
  // Verified IDs from quran.com API
  { id: 131, name: 'The Clear Quran (Khattab)',   language: 'English' },
  { id: 85,  name: 'Saheeh International',         language: 'English' },
  { id: 20,  name: 'Yusuf Ali',                    language: 'English' },
  { id: 57,  name: 'Pickthall',                    language: 'English' },
  { id: 21,  name: 'Hilali & Khan',                language: 'English' },
  { id: 22,  name: 'Shakir',                       language: 'English' },
  { id: 95,  name: 'Clear Quran (Hasan Fatih)',    language: 'Turkish' },
  { id: 77,  name: 'Bubenheim & Elyas',            language: 'German' },
  { id: 31,  name: 'Hamidullah',                   language: 'French' },
  { id: 97,  name: 'Jalandhry',                    language: 'Urdu' },
  { id: 33,  name: 'Indonesian Ministry of Religion', language: 'Indonesian' },
  { id: 45,  name: 'Kuliev',                       language: 'Russian' },
  { id: 16,  name: 'تفسير الميسر',                 language: 'Arabic' },
]
