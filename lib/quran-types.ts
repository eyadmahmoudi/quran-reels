...
export interface ReelConfig {
  ...
  showHijriDate: boolean               // show Hijri date overlay on the reel
  showTafsir: boolean                  // show tafsir explanation below translation
  showJuzProgress: boolean             // show Juz/Hizb progress indicator
}
...
export const BUILTIN_PRESETS: ReelPreset[] = [
  {
    ...
    displayMode: 'minimal',
    reciterId: 1, reciterFolder: 'Abdul_Basit_Mujawwad_128kbps', qdcRecitationId: 1,
    showTranslation: true, translationId: 20,
  ...
  },
  {
    ...
    displayMode: 'classic',
    reciterId: 8, reciterFolder: 'Alafasy_128kbps', qdcRecitationId: 7,
    showTranslation: true, translationId: 20,
    showHijriDate: true, showTafsir: false, showJuzProgress: false,
  },
  {
    id: 'kaaba-serenity',
    name: 'Kaaba Serenity',
    ...
    displayMode: 'minimal',
    reciterId: 3, reciterFolder: 'Abdurrahmaan_As-Sudais_192kbps', qdcRecitationId: 3,
    showTranslation: true, translationId: 20,
    showHijriDate: true, showTafsir: false, showJuzProgress: true,
  },
  {
    id: 'kufi-modern',
    name: 'Kufi Modern',
    ...
    displayMode: 'minimal',
    reciterId: 5, reciterFolder: 'Hani_Rifai_64kbps', qdcRecitationId: 5,
    showTranslation: false, translationId: 20,
    showHijriDate: false, showTafsir: false, showJuzProgress: false,
  },
  {
    id: 'scholar-tafsir',
    ...
    displayMode: 'classic',
    reciterId: 6, reciterFolder: 'Husary_128kbps', qdcRecitationId: 6,
    showTranslation: true, translationId: 20,
    showHijriDate: true, showTafsir: true, showJuzProgress: true,
  },
  {
    id: 'emerald-nature',
    name: 'Emerald Nature',
    ...
    displayMode: 'minimal',
    reciterId: 2, reciterFolder: 'Abdul_Basit_Murattal_192kbps', qdcRecitationId: 2,
    showTranslation: true, translationId: 22,
    showHijriDate: false, showTafsir: false, showJuzProgress: false,
  },
]

// ── Tafsir Resources (Quran.com API v4) ──────────────────────────
export const TAFSIR_RESOURCES = [
  { id: 151, name: 'Tafsir As-Sa\'di', language: 'Arabic' },
  { id: 169, name: 'Tafsir Ibn Kathir (Ar)', language: 'Arabic' },
  { id: 170, name: 'Tafsir Muyassar (Ar)', language: 'Arabic' },
]
